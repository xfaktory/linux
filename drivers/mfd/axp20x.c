...
static const struct resource axp803_battery_resources[] = {
	...
	DEFINE_RES_IRQ_NAMED(AXP803_IRQ_BATT_ENT_ACT_MODE, "BATT_ENT_ACT_MODE"),
	DEFINE_RES_IRQ_NAMED(AXP803_IRQ_BATT_EXIT_ACT_MODE, "BATT_EXIT_ACT_MODE"),
	DEFINE_RES_IRQ_NAMED(AXP803_IRQ_CHARG, "CHARG"),
	DEFINE_RES_IRQ_NAMED(AXP803_IRQ_CHARG_DONE, "CHARG_DONE"),
	...
	DEFINE_RES_IRQ_NAMED(AXP803_IRQ_LOW_PWR_LVL1, "LOW_PWR_LVL1"),
	DEFINE_RES_IRQ_NAMED(AXP803_IRQ_LOW_PWR_LVL2, "LOW_PWR_LVL2"),
};
